...
<!-- coverage:begin -->
- `pool_size: 144` is the honest denominator and the `note` says what it excludes. Coverage here is 12 of 165 admitted records audited.
<!-- coverage:end -->
