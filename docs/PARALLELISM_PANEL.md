...
<!-- census:begin -->
- **12 of 165** admitted records are published — this catalog is audited-only — and **153** sit in `data/pool.json`: 9 captured, scored and held for cause · 144 never captured at all.
...
- 117 pipeline tests, every surface regenerated by `make build`, and `make verify` fails the build if this block and `catalog-stats.json` ever disagree — including this block.
<!-- census:end -->
